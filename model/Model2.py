'''
    Module to extract the top-K packages based on  Model2
'''
import sys
import os.path as o
...
if __name__ == "__main__":
    ...
    dh.save_top_packages_list( packages_path + "Model2_top_packages.txt", top_packages )
